...
import profSite from "../../images/profile_site.jpeg";
import digitalSite from "../../images/Digital-agency-website.png";
import xenoV2 from "../../images/xono-v2-dev.png";
          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              <div className="_project_portfolio_single_card" href="https://kaziamran.github.io/xono-v2-dev/" target='_blank'>
                <div className="_project_portfolio_card_img">
                  <img src={xenoV2} className='img-fluid _project_portfolio_card_img_tag' alt="image" />
                </div>
                <div className="_project_portfolio_card_content pt-3">
