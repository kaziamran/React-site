                                ...
                                <div className="_home_portfolio_social_link_nav">
                                    <ul className='_home_portfolio_social_link_nav_ul'>
                                        <li className='_home_portfolio_social_link_nav_li'>
                                            <a href="#0" className='_home_portfolio_social_link_nav_link'>
                    ...
                    <div className='col-lg-8 col-md-12 col-sm-12'>
                        <div className="_home_portfolio_cnt">
                            ...
                            <div className="_home_portfolio_cnt_btns">
                                ...
                                <a href='https://drive.google.com/file/d/1j2VTZlGG4YYFgo_Rhl95Zkdhrgb8Uh-0/view?usp=share_link' className='_home_portfolio_cnt_btn1' target='_blank'>Download cv</a>
                                <a href='https://wa.me/+8801866749596' className='_home_portfolio_cnt_btn2'>Hire me
